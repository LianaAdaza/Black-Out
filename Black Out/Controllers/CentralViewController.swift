...
class CentralViewController: UIViewController, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource {
    
    @IBOutlet var centralTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        businesses = allBusinesses.getCentralBusinesses()
    }
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let business = allBusinesses.getCentralBusinesses()[indexPath.row]
