...
class SoFloViewController: UIViewController, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource {
    
    @IBOutlet var sofloTableView: UITableView!
    var allBusinesses = BusinessDB.sharedInstance
    var businesses: [Business] = []
    
    override func viewDidLoad() {
        super.viewDidLoad()
        sofloTableView.delegate = self
        sofloTableView.dataSource = self
        businesses = allBusinesses.getSoFloBusinesses()
    }
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let business = allBusinesses.getSoFloBusinesses()[indexPath.row]
